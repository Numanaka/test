...
alter table fruitstock modify season varchar(255);
update fruitstock set season="a";

alter table fruitstock drop season;

alter table fruitstock drop madein;

drop table fruitstock;
